    ...
    <>
      <div className={styles.footerPrincipal}>
        ...
        <div className={styles.footer}>
              <a className={styles.footerContainer} href="https://www.linkedin.com/feed/">
              <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-linkedin" viewBox="0 0 16 16">
                ...
                <p>
                  Jonatan Moreno Ramos
                </p>
              </a>
              <a className={styles.footerContainer} href="https://github.com/jonatan85">
              <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-brand-github-filled" width="30" height="30" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#393939" fill="none" strokeLinecap="round" strokeLinejoin="round">
